...
static lv_display_t *flush_disp;
static void lcd_send_color(lv_display_t *disp, const uint8_t *cmd, size_t cmd_size, uint8_t *param, size_t param_size)
{
    ...
    DMA2_CHANNEL2->dtcnt = param_size / 2;
    DMA2_CHANNEL2->maddr = (uint32_t)param;
...
void DMA2_Channel2_IRQHandler(void)
{
    ...
    lv_display_flush_ready(flush_disp);
    flush_disp = NULL;
...
lv_display_t *display_init(void)
{
    ...
    nvic_irq_enable(DMA2_Channel2_IRQn, 8, 0);
