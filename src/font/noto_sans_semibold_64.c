 ...
 * Size: 64 px
 * Bpp: 4
 * Opts: --bpp 4 --size 64 --no-compress --stride 1 --align 1 --font NotoSans-SemiBold.ttf --symbols  -.0123456789L --format lvgl -o noto_sans_semibold_64.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 7403, .adv_w = 559, .box_w = 29, .box_h = 45, .ofs_x = 5, .ofs_y = 0}
};
...
{
    {
        .range_start = 32, .range_length = 45, .glyph_id_start = 1,
